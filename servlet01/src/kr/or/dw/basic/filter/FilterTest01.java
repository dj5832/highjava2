...
// 필터 Class는 javax.servlet.Filter 인터페이스를 구현해서 작성 해야한다.
...
public class FilterTest01 implements Filter{
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		System.out.println("첫번째 Filter - chain.doFilter() 메서드 호출 전");
		
		// 필수로 들어가야하는 것 
		chain.doFilter(req, res);	// 다음 필터로 체이닝하는 메서드(다른 필터로 제어권을 넘겨주는 명령어)
	...
	@Override
	public void destroy() {
		System.out.println("첫번째 Filter - destory() 메서드 호출");
	}
