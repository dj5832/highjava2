...
public class 
RequestWrapperFilter implements Filter{
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		// ResuestWrapper 객체 생성
		// ServletRequest가 HttpServletRequest 보다 조상이라서 형변환을 해줘야한다.
		RequestWrapperTest reqWrapper = new RequestWrapperTest((HttpServletRequest)request);
		//만양 ResponseWrapper 객체도 등록 하려면 이곳에서 같이 생성한다.
