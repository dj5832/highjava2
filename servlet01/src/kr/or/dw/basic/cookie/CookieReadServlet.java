...
public class CookieReadServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		out.println("<html><head><meta charset='utf-8'><title>Cookie 확인하기</title></head>");
		out.println("<body>");
		...
		if(cookieArr == null || cookieArr.length == 0) {
			...
			// URLDecoder.decode() 메서드 사용
				out.print("쿠키변수 : " + c.getName() + "<br>");
				out.print("쿠키 값 : " + URLDecoder.decode(c.getValue(), "utf-8") + "<hr>");
			}
			out.println("<br><br>");
		}
		out.println("<a href='" + req.getContextPath() + "/basic/02/cookieTest.jsp'>시작으로 돌아가기</a>");
