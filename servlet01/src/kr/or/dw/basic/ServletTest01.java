...
// - 	8080, 80....	==> PORT번호 (80번은 생략가능)
// - /servletTest		==> 컨텍스트 패스(보통 '웹프로젝트 이름' 으로 자동 지정된다.)
// - /servletTest01.do	==> 서플릿 요청 URL 패턴

// Servlet 클래스는 HttpServlet울 상속해서 작성한다.
...
public class ServletTest01 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		response.setCharacterEncoding("UTF-8"); // 응답문서의 인코딩 방식지정
		...
		out.append("<html>").append("<head>").append("<meta charset='utf-8'>")
			.append("<title>첫번째Servlet 연습</title>").append("</head>").append("<body>")
			.append("<h1 style='text-align:center; color:red;'>").append("안녕하세요. 첫번째Servlet 프로그램 입니다.<br>")
