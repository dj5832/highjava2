...
public class JsonTestServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		res.setContentType("application/json");  // json 형태로 내보내겠다는 의미
...
//		out.println(jsonStr);  // 응답데이터가 문자열인 경우
//		out.println(jsonArr);  // 응답데이터가 배열인 경우
//		out.println(jsonObj);  // 응답데이터가 객체인 경우
		out.println(jsonList);  // 응답데이터가 List인 경우
