...
public class CryptoUtil {
	...
	// MD5(message-digest algorithm)는 콘텐츠 검증 및 디지털 서명 뿐만 아니라
	// 메시지 인증에 사용되는 해시 알고리즘.
	// MD5는 보낸 파일과 받은 파일이 일치하는지 확인하는 해시 함수를 기반으로 한다.
	 ...
	 * SHA 이름의 예로는 SHA-1, SHA-2, SHA-256, SHA-512, SHA-224, SHA-384 가 있지만
	 * 실제로는 SHA-1 및 SHA-2의 두가지 유형이 있다 (SHA-3 도 있음. 안정성이 떨어짐)
	 */
