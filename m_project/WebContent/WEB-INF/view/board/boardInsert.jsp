					...
					<%  }   %>
						<div class="card-body">
							<div class="form-group">
								...
								<input type="text" name="title" id="inputName" class="form-control" required value="<%=boardVo != null ? boardVo.getBd_title() : ""%>">
							</div>
							<div class="form-group">
								<label for="inputDescription">내용</label>
								<textarea id="inputDescription" class="form-control" name="content" rows="4"><%=boardVo != null ? boardVo.getBd_content() : ""%></textarea>
							</div>
							<div>
